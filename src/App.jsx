            ...
            <div className="md:hidden mt-4 pb-4 space-y-3 animate-fadeIn">
              {['home', 'about', 'experience', 'projects', 'testimonials', 'services', 'contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item)}
                  className={`block w-full text-left capitalize py-2 transition-all ${
      ...
      <section id="home" className="min-h-screen flex items-center pt-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-full overflow-hidden w-100 h-100 bg-gradient-to-r from-blue-500 to-purple-600 ml-50 p-2 relative animate-fadeInLeft">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {services.map((service, idx) => (
              <div key={idx} className={`relative bg-gray-800/50 rounded-xl p-6 border transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                service.popular ? 'border-blue-500 shadow-lg shadow-blue-500/20' : 'border-gray-700'
              }`}>
                {service.popular && (
